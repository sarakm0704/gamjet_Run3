...
class Analysis(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        # HERE
        events = selection.photonSelection(events)
        self.counter.increment('photon',events)
        ...
        #events = events[(events.leadingJet.pt > 20)]
        ...
        #events = events[selection.Jietid(events.Jet)]
