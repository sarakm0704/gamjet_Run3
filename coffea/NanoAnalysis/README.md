...
```
cd existing_repo
git remote add origin https://gitlab.cern.ch/HPlus/nanoAnalysis.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.cern.ch/HPlus/nanoAnalysis/-/settings/integrations)
